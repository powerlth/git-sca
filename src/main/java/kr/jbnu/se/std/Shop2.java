...
public class Shop2 {
    ...
    private int selectedItem = -1; // 선택된 아이템 인덱스
    ...
    public void drawShopUI(Graphics2D g2d, int frameWidth, int frameHeight, Component component) throws IOException {
        // 상점 배경 그리기
